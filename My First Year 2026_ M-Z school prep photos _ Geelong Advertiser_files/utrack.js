...
if (!newskey.utrack_loaded || false) {
  newskey.geo = {};  utag_data.newskey_geo_country = newskey.geo.country="AU".toLowerCase();   utag_data.newskey_geo_region = newskey.geo.region= "VIC".toLowerCase();   utag_data.newskey_geo_city = newskey.geo.city= "MELBOURNE".toLowerCase();   utag_data.newskey_geo_lat = newskey.geo.lat= "-37.82".toLowerCase();   utag_data.newskey_geo_long = newskey.geo.long= "144.97".toLowerCase();   utag_data.newskey_geo_tmz = newskey.geo.tmz= "GMT+10".toLowerCase();    utag_data.newskey_geo_network = newskey.geo.network= "unknown";  
  (function(){
